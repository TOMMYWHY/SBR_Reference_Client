...
/**
 * The frame that describes this software product.
 */
public class SBRJavaClientAboutBox extends javax.swing.JDialog {

	private static final long serialVersionUID = -340258526189168822L;
	public SBRJavaClientAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(au.gov.sbr.core.client.gui.SBRJavaClientApp.class).getContext().getResourceMap(SBRJavaClientAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(au.gov.sbr.core.client.gui.SBRJavaClientApp.class).getContext().getActionMap(SBRJavaClientAboutBox.class, this);
